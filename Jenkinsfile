        ...
        stage('Build and Setup Database') {
            steps {
                script {
                    ...
                    sh 'sudo docker run -d --name mysql-container -e MYSQL_ROOT_PASSWORD=mysql -e MYSQL_DATABASE=quizonline -e MYSQL_USER=root3 -e MYSQL_PASSWORD=mysql -p 3306:3306 mysql:latest'
